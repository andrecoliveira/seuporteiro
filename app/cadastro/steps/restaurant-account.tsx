...
export default function RestaurantAccount(props: SignUpViewProps) {
  const { accountForm, handleSubmit } = props
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="flex items-center gap-2 text-sm">
            <CircleCheck
              size={16}
              className={props.validation.case ? 'text-emerald-600' : undefined}
            />
